module collection_efficiency
    ...
    real(dp), parameter :: E_hall(NR, NP) = reshape([ &
        ...
        0.79,  0.93,  0.96,  1.00, &
        ! p=0.15
        0.014, 0.014, 0.005, 0.02,  0.28,  0.60,  0.64,  0.75, &
        0.91,  0.97,  0.98,  1.00, &
        ! p=0.20
        0.017, 0.017, 0.016, 0.04,  0.50,  0.70,  0.77,  0.84, &
        0.95,  0.97,  1.00,  1.00, &
        ! p=0.25
        0.019, 0.019, 0.022, 0.085, 0.62,  0.78,  0.84,  0.88, &
        0.95,  1.00,  1.00,  1.00, &
        ! p=0.30
        0.022, 0.022, 0.030, 0.17,  0.68,  0.83,  0.87,  0.90, &
        1.00,  1.00,  1.00,  1.00, &
        ! p=0.35
        0.027, 0.027, 0.043, 0.27,  0.74,  0.86,  0.89,  0.92, &
        1.00,  1.00,  1.00,  1.00, &
        ! p=0.40
        0.030, 0.030, 0.052, 0.40,  0.78,  0.88,  0.90,  0.94, &
        1.00,  1.00,  1.00,  1.00, &
        ! p=0.45
        0.033, 0.033, 0.064, 0.50,  0.80,  0.90,  0.91,  0.95, &
        1.00,  1.00,  1.00,  1.00, &
        ! p=0.50
        0.035, 0.035, 0.072, 0.55,  0.80,  0.90,  0.91,  0.95, &
        1.00,  1.00,  1.00,  1.00, &
        ! p=0.55
        0.037, 0.037, 0.079, 0.58,  0.80,  0.90,  0.91,  0.95, &
        1.00,  1.00,  1.00,  1.00, &
        ! p=0.60
        0.038, 0.038, 0.082, 0.59,  0.78,  0.90,  0.91,  0.95, &
        1.00,  1.00,  1.00,  1.00, &
        ! p=0.65
        0.038, 0.038, 0.080, 0.58,  0.77,  0.89,  0.91,  0.95, &
        1.00,  1.00,  1.00,  1.00, &
        ! p=0.70
        0.037, 0.037, 0.076, 0.54,  0.76,  0.88,  0.92,  0.95, &
        1.00,  1.00,  1.00,  1.00, &
        ! p=0.75
        0.036, 0.036, 0.067, 0.51,  0.77,  0.88,  0.93,  0.97, &
        1.00,  1.00,  1.00,  1.00, &
        ! p=0.80
        0.035, 0.035, 0.057, 0.49,  0.77,  0.89,  0.95,  1.00, &
        1.00,  1.00,  1.00,  1.00, &
        ! p=0.85
        0.032, 0.032, 0.048, 0.47,  0.78,  0.92,  1.00,  1.02, &
        1.00,  1.00,  1.00,  1.00, &
        ! p=0.90
        0.029, 0.029, 0.040, 0.45,  0.79,  1.01,  1.03,  1.04, &
        1.00,  1.00,  1.00,  1.00, &
        ! p=0.95
        0.027, 0.027, 0.033, 0.47,  0.95,  1.30,  1.70,  2.30, &
        1.00,  1.00,  1.00,  1.00, &
        ! p=1.00
